...
class Major:
    ...
    def __init__(self, dept: str, required: str, electives: str) -> None:  # JRR: you don't know the required or electives until after the Major is created
        self._dept: str = dept
        # JRR: self._required: List[str] = required   # or use set()
        # JRR: self._electives: List[str] = electives
        self._required: Set[str] = required
        self._electives: Set[str] = electives
...
class Repository:
    ...
    def __init__(self, wdir: str, ptables: bool=True) -> None:
        self._students: student()   #_students[cwid] = student()
    ...
    def _read_majors(self, path: str, Major: str) -> None:
        ...
        """
        # JRR for major, flag, course in file_reader(path, 3, sep='\t', header=False/True):
    ...
    def _read_students(self, path: str, ptables: bool=True) -> None:
        """read rach line from path/students.txt and create 
         ...
         """
        # JRR for cwid, name, major in file_reader(path,3, sep = ';', header = False):
